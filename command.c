...
#endif
	/* add by liangdongcai, 2012-3-8 */
	install_auto_complete_handler("upgseqnum", var_complete);
	install_auto_complete_handler("macprog2", var_complete);
	install_auto_complete_handler("printsernum", var_complete);
	install_auto_complete_handler("sernumprog", var_complete);
	install_auto_complete_handler("reset_upd", var_complete);
	install_auto_complete_handler("restore_orig", var_complete);
